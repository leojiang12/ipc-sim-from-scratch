...
Eigen::VectorXd search_dir(const Eigen::VectorXd& x, Eigen::VectorXd& x_tilde,  
    ...
    PCGResult r = pcg(matvec, -grad, opts);   // P p = -g : P is proj hess, g is grad, p is our search direction
